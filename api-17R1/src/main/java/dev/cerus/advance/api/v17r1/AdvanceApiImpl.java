package dev.cerus.advance.api.v17r1;
...
public class AdvanceApiImpl implements AdvanceApi {
    ...
    public void showAdvancement(final Advancement advancement, final Player... players) {
        ...
        for (final Player player : players) {
            ((CraftPlayer) player).getHandle().b.sendPacket((Packet<?>) showPacket);
            ((CraftPlayer) player).getHandle().b.sendPacket((Packet<?>) clearPacket);
        }
    }
